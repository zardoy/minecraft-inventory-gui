...
layouts.SmithingTable = {
  with: {
    smithing_table: { path: 'gui/container/smithing', slice: [0, 0, 176, 166] }
  },
  type: 'image',
  using: 'smithing_table',
  children: [
    { type: 'itemgrid', containing: 'templateItem', x: 8, y: 48, width: 1, height: 1 },
    { type: 'itemgrid', containing: 'baseItem', x: 26, y: 48, width: 1, height: 1 },
    { type: 'itemgrid', containing: 'additionItem', x: 44, y: 48, width: 1, height: 1 },
    { type: 'itemgrid', containing: 'resultItem', x: 98, y: 48, width: 1, height: 1 },
    { type: 'itemgrid', containing: 'inventoryItems', x: 8, y: 84, width: 9, height: 3 },
    { type: 'itemgrid', containing: 'hotbarItems', x: 8, y: 142, width: 9, height: 1 }
  ]
}

layouts.SmithingTableLegacy = {
  with: {
    smithing_table: { path: 'gui/container/smithing', slice: [0, 0, 176, 166] }
  },
  type: 'image',
  using: 'smithing_table',
  children: [
    { type: 'itemgrid', containing: 'baseItem', x: 27, y: 47, width: 1, height: 1 },
    { type: 'itemgrid', containing: 'additionItem', x: 76, y: 47, width: 1, height: 1 },
    { type: 'itemgrid', containing: 'resultItem', x: 134, y: 47, width: 1, height: 1 },
    { type: 'itemgrid', containing: 'inventoryItems', x: 8, y: 84, width: 9, height: 3 },
    { type: 'itemgrid', containing: 'hotbarItems', x: 8, y: 142, width: 9, height: 1 }
  ]
}
